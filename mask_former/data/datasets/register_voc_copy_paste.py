...
def register_copy_paste_voc_full(root):
    root = os.path.join(root, "neurips2023", "maskformer_voc")
    meta = _get_voc_full_meta()
    image_dir = os.path.join(root, "images")
    gt_dir = os.path.join(root, "annotations")
    name = f"voc_copy_paste_sem_seg_train"
...
register_copy_paste_voc_full(_root)
